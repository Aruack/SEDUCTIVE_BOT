...
async def start(event):
  await event.reply("^_^ Hey, Welcome To TAG Help Bot's Menu\nI can tag 15,000 Members in Group and 300 Members In Channel.\nNeed Help /help ",
                    buttons=(
                      [
                         Button.url('📣 UPDATES', 'https://t.me/Aruackofficial'), 
                         Button.url('⭐SUPPORT', 'https://t.me/Aruacksupport'), 
                      ], 
                      [
                        Button.url('➕ ADD ME TO YOUR GROUP', 'https://t.me/SEDUCTIVE_BOT?startgroup=true'),   
                      ]
                   ), 
                    link_preview=False
                   )
...
print("¯\_(ツ)_/¯ Need Help Join @Aruacksupport")
